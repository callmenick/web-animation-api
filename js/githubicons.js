(function(){
  ...
  gitFork.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=web-animation-api&type=fork&count=true');
  ...
  gitWatch.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=web-animation-api&type=watch&count=true');
